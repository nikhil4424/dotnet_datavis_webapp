...
DB_MODEL_FILE="/docker-entrypoint-initdb.d/schema.sql"
COUNTRY_CSV_FILE="/docker-entrypoint-initdb.d/country.csv"
YEAR_CSV_FILE="/docker-entrypoint-initdb.d/year.csv"
CROP_CSV_FILE="/docker-entrypoint-initdb.d/country.csv"
CROP_YIELD_CSV_FILE="/docker-entrypoint-initdb.d/crop_yield.csv"
CROPYIELDS_VIEW_CSV_FILE="/docker-entrypoint-initdb.d/view_yield.sql"
